...
function signUp() {
    ...
    if (name) {
            ...
            if (lastName) {
                    const email = prompt('Придумайте електронну пошту');
                    if (email) {
                            const pasword = prompt('Придумайте пароль');
                            if (pasword.length > 5) {
                                console.log(name);
                            }
                            else {
                                confirm('Ви не ввели пароль');
                            }
                        console.log(lastName);
                    } else {
                        confirm('Ви не ввели emeil');
                    }
                    console.log(email);
            } else {
                confirm('Ви не ввели фамілію');
            }
        console.log(pasword);
    } else {
        confirm('Ви не ввели імʼя');
    }
}
